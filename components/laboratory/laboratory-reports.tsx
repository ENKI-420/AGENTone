import { useEffect, useState, useCallback, useCallback, useCallback, useCallback, useCallback } from "react";
import { IconFlask, IconLoader, IconRefresh, IconAlertCircle, IconRefresh, IconAlertCircle, IconRefresh, IconAlertCircle, IconRefresh, IconAlertCircle, IconRefresh, IconAlertCircle } from "@tabler/icons-react";
      ...
      <CardContent>
        ...
        {error && (
          <div className="mt-4 p-3 rounded-md bg-red-50 text-red-600 text-sm flex items-center gap-2">
            <IconAlertCircle className="h-5 w-5 flex-shrink-0" /abResults, setLabResults] = useState<LabResult[]>([]);
  const [loading, setLoading] = useState<boolean>(isLoading);
  const [error, setError] = useState<string | null>(null);
  ...
  return (
    <Card className="w-full">
      ...
      <CardContent>
        ...
        {/* Loading State */}
        {loading ? (
          <div className="mt-4 p-6 flex flex-col items-center justify-center text-center"abResults, setLabResults] = useState<LabResult[]>([]);
  const [loading, setLoading] = useState<boolean>(isLoading);
  const [error, setError] = useState<string | null>(null);
